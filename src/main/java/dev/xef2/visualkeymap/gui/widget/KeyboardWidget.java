...
public class KeyboardWidget extends AbstractLayout {
    ...
    private class KeyWidget extends AbstractButton {
        ...
        @Override
        protected void renderWidget(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float f) {
            int borderColor;
            ...
            this.renderString(guiGraphics, Minecraft.getInstance().font, CommonColors.WHITE);
        }
    }
}
