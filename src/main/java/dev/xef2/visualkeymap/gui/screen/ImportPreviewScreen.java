        ...
        class ImportEntry extends ContainerObjectSelectionList.Entry<ImportEntry> {
            ...
            ImportEntry(KeymapSnapshot.ImportMatch match) {
                ...
                this.checkbox = Checkbox.builder(Component.empty(), minecraft.font)
                        ...
                        .onValueChange((checkbox, selected) -> match.selected = selected)
                        .build();
            ...
            @Override
            public void renderContent(@NotNull GuiGraphics graphics, int mouseX, int mouseY, boolean hovered, float f) {
                int y = this.getContentY();

                this.checkbox.setX(this.getContentX());
                this.checkbox.setY(y + (ENTRY_HEIGHT - this.checkbox.getHeight()) / 2);
                this.checkbox.render(graphics, mouseX, mouseY, f);
                ...
                this.nameWidget.render(graphics, mouseX, mouseY, f);
                ...
                this.changeWidget.render(graphics, mouseX, mouseY, f);
            }
